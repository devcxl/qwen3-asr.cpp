...
private:
  ...
  bool parse_wav_from_memory(const std::vector<uint8_t> &data, int &sample_rate,
                             int &channels, std::vector<float> &samples);
  ...
  static std::string json_pair(const std::string &key, double val,
                               int precision = 4);
